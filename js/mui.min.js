...
function(a, b) {
    ...
    $(".header div").css('height',$(".header").height()+"px");
    $(".header div").css('line-height',$(".header").height()+"px");
    $(".header span").css('height',$(".header").height()+"px");
    $(".header span").css('line-height',$(".header").height()+"px");
    $(".content").css('top',$(".header").height()+"px");
    
    //a.path='http://www.52lmkj.com';
    a.path='http://192.168.2.100:8080';
    a.photo='http://www.52huize.com:5000';
    
    //检查网络
    a.isNetwork=function(){
    	var network = true;
		if(mui.os.plus){
    ...
    //开启等待
    a.openWaiting=function(){
		$("body").append("<div class='loading-mask'></div>");
	}
    
    //关闭等待
	a.closeWaiting=function(){
		$(".loading-mask").remove();
	}
	
	//登录成功
	a.login_success=function(){
		if(localStorage.getItem('user')){
			 var user=JSON.parse(localStorage.getItem('user'));
			 $(".login_info").css('display','none');
			 $('.person_m').text(user.mobile);
			 $('.logo').attr('src',user.photo);
    ...
    a.isLogin=function(){
	 $.ajax({
    	url:mui.path+"/app/guiderIsLogin?callback=?",
        dataType:'json',
        type:'post',
        	      ...
        	      if(!res.success) {
			        ...
			        mui.alert(res.message,function(){
			          a.login_fail();
			      	 ...
			      	 localStorage.setItem('user',JSON.stringify(res.guider));
			      	 a.login_success();
			      }
        },
